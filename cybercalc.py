...
atl4.grid(row=3,column=1,columnspan=3,padx=(10,5),pady=(5,5),ipadx=0,ipady=0,sticky=E+W)
...
aql2.grid(row=2,column=1,columnspan=3,padx=(10,5),pady=(5,5),ipadx=0,ipady=0,sticky=E+W)
...
arl3.grid(row=3,column=1,columnspan=3,padx=(10,5),pady=(5,5),ipadx=0,ipady=0,sticky=E+W)
