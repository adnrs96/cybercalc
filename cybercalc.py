...
b_back = Button(f3, text=" AC ",bg="#434343",fg="#FFFFFF",highlightthickness=0,font=("Helvetica", 12),command= lambda: action_clear(expr_inp))
b_back.grid(row=1, column=5,columnspan=1,padx=(5,5),pady=(10,5),sticky=E+W)
...
b_cb.grid(row=3, column=5,columnspan=1,padx=(5,5),pady=(5,5),sticky=E+W)
...
b_per = Button(f3, text="  C  ",bg="#434343",fg="#FFFFFF",highlightthickness=0,font=("Helvetica", 12),command= lambda: action_trimLast(expr_inp))
